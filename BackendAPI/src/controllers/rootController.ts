...
import { inscription, login, getStats, uploadStats, confirmEmail, newConfirmationEmail, getModVersions, getModDownload } from './endpointOperations/rootControllerOperations';
